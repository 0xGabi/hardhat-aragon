...
import { TASK_PUBLISH } from '~/src/internal/task-names'
import { startGanache } from '~/src/internal/start/backend/start-ganache'
import deployBases from '~/src/internal/start/backend/bases/deploy-bases'
import {
